...
This pseudo-header is used in current implementations of UDP/SCION on top of SCION. However, checksums across layers are not recommended and should be re-evaluated in future evolutions.
