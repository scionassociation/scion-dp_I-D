...
This timestamp wraps around every 2^32 seconds (roughly 136 years). The next wraparound will occur in year 2106. Care should be taken by implementations while computing validity during a wraparound.
